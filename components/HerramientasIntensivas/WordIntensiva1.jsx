...
export default function WordIntensiva1() {
  return (
    <ImageBackground 
      ...
      <ScrollView>
        ...
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.paragraph}><Text style={styles.keyword}>2. El 4-1-1: </Text>
            Este filtro consiste en preguntar sobre metas. A través de estas preguntas, podemos filtrar quién realmente está comprometido y quién no está obedeciendo.
          </Text>  

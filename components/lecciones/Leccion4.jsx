...
export default function Leccion4({ route }) {
  ...
  <Text style={[estilosIndividual.cellText, estilosIndividual.liderazgoSubText]}>• Dinámica de la multiplicación</Text>
</View>
            </View>
          </View>
        </>
...
const estilosIndividual = StyleSheet.create({
  ...
  liderazgoSubText: {
    marginLeft: 18, // desplazamiento de 4 px a la derecha
    fontSize: 13, // o ajusta a tu preferencia
  },
});
